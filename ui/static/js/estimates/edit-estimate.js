...
function setupSubmitEstimateButton() {
  let submitButton = document.querySelector(".submit-btn");
  const estimateID = document.querySelector(".estimate-ID").dataset.estimateId;

  submitButton.addEventListener("click", async function () {
    try {
      const response = await fetch(`/estimate/${estimateID}/progress`, {
        method: "POST",
      });
